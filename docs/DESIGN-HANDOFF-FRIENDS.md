...
- **Passing the big story:**
  ...
  - **Passed** (`PhoneNewFriend`):
    - paper confetti and the new level rosette: "Reading level 3!" and "Oggy is your new friend";
    - both friends side by side, and the friend's signature item ("Oggy gave you a spotty neckerchief");
    - buttons: **Later** and **Go to the pond**.
  - **Not yet:**
    - "Oggy will wait for you at the pond."
    - The path stays full.
...
| Order | Bob | Oggy | Button | Marmalade | Barnacle | Bartholomew |
|---|---|---|---|---|---|---|
...
- **Slots:** `head`, `eyes`, `neck`, `body` and `back`, plus `claws` for Barnacle and `antennae` for Bartholomew. One item per slot.
...
- **Home** (`PhoneHome`):
  ...
  - a chip reading "Level 2 · 412 of 500 to Oggy" with a mini ribbon;
...
| `crab` | Barnacle | 6 | striped sailor neckerchief | seashells | Rock Pools | 16 | 0 0 −30 −60 −30 0 0 0 |
| `grasshopper` | Bartholomew | 7 | brown leather satchel | clover leaves | Tall Grass | 14 | 0 0 −60 −130 −110 −50 0 0 |
...
- **Hop strips:** `sprites/<key>-hop.png` are 8-frame strips, 440 px tall, with the feet on one baseline and the lift baked in.
  ...
  - Barnacle's frame 8 repeats frame 1.
